export const projects = [
  ...
  },
  {
    ...
    description:
      "This project consists of the Front-End development for a management software built for a technology company. The system is designed to handle stock, users, mobile units, and completed jobs in a modern, intuitive, and scalable way. It allows administrators and workers to optimize their workflows through clear and functional interfaces, integrating advanced features for search, tracking, and reporting.",
    keyFeatures: [
      "Role-based login with differentiated views for administrators and workers.",
      "Comprehensive management per branch/location, each with its own stock, users, mobile units, and jobs.",
      "Advanced stock management with smart search, bulk import, and support for serial numbers, barcodes, and fractional units of measure.",
      "Mobile unit management and tracking with product assignments via barcode scanning or manual input.",
      "Job records with multiple details (work order number, address, assigned technicians, products used, etc.).",
      "User administration with roles, contact information, and assigned mobile units.",
      "Comparative reports exportable to .csv for job verification and performance analysis.",
    ],
    status: "Private",
    image: "/trabajo8.webp",
    skillsFront: ["/react.svg", "/typescript.svg", "/vite.svg"],
    skillsBack: [],
    skillsOthers: ["/git.svg", "/github.svg", "/tailwind.svg"],
    code: "",
    page: "",
  },
];
...
export const projectsSpanish = [
  ...
  },
  {
    ...
    description:
      "Una aplicación de chat en tiempo real que permite a los usuarios comunicarse instantáneamente a través de grupos públicos, privados o mensajes directos. Los perfiles de usuario pueden personalizarse con nombre, avatar, ubicación y biografía. La plataforma también permite compartir imágenes, haciendo las conversaciones más dinámicas y atractivas. Construida con foco en rendimiento y adaptabilidad, garantiza una experiencia fluida en todos los dispositivos y una conexión confiable en tiempo real gracias a la tecnología WebSocket.",
    keyFeatures: [
  ...
  {
    id: 7,
    title: "Software Tecnológico",
    description:
      "Este proyecto corresponde al desarrollo del Front-End de un software de gestión para una empresa del rubro tecnológico. El sistema está diseñado para administrar stock, usuarios, móviles y trabajos realizados de manera moderna, intuitiva y escalable. Permite a administradores y trabajadores optimizar su flujo de trabajo a través de interfaces claras y funcionales, integrando características avanzadas de búsqueda, seguimiento y reportes.",
    keyFeatures: [
      "Login con roles diferenciados para administradores y trabajadores.",
      "Gestión integral por bases/locales, cada una con su propio stock, usuarios, móviles y trabajos.",
      "Stock avanzado con búsqueda inteligente, carga masiva y soporte para seriales, códigos de barras y fracciones (unidades de medida).",
      "Gestión y seguimiento de móviles con asignaciones mediante escaneo o carga manual.",
      "Registro de trabajos realizados con múltiples datos (Nº OT, dirección, técnicos, productos utilizados, etc.).",
      "Administración de usuarios con roles, datos de contacto y móviles asignados.",
      "Reportes comparativos exportables en .csv para verificar trabajos y eficiencia.",
    ],
    status: "Private",
    image: "/trabajo8.webp",
    skillsFront: ["/react.svg", "/typescript.svg", "/vite.svg"],
