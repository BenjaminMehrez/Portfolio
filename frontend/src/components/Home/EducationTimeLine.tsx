...
function EducationTimeLine() {
  ...
  return (
    <section
      ...
      className="max-w-6xl mx-auto my-20 px-6 xl:px-0"
    >
      ...
      <ul className="flex flex-col lg:flex-row mt-10 list-disc list-inside lg:list-none lg:text-center lg:text-sm">
        <li className="duration-400 hover:text-purple-600 font-semibold border-l-2 pl-2 py-4 lg:border-l-0 lg:border-b-2 lg:px-5">
          ...
          <span className="hidden lg:inline-flex z-40 relative lg:top-7 -left-12 rounded-full bg-white">
            .
          </span>
        </li>
        <li className="duration-400 hover:text-purple-600 font-semibold border-l-2 pl-2 py-4 lg:border-l-0 lg:border-b-2 lg:px-5">
          JavaScript <span className="hidden sm:inline-flex">CoderHouse</span>
          <span className="hidden lg:inline-flex z-40 relative lg:top-7 xl:-left-12 rounded-full bg-white">
            .
          </span>
        </li>
        <li className="duration-400 hover:text-purple-600 font-semibold border-l-2 pl-2 py-4 lg:border-l-0 lg:border-b-2 lg:px-5">
          React <span className="hidden sm:inline-flex">CoderHouse</span>
          <span className="hidden lg:inline-flex z-40 relative top-7 xl:-left-11 rounded-full bg-white">
            .
          </span>
        </li>
        <li className="duration-400 hover:text-purple-600 font-semibold border-l-2 pl-2 py-4 lg:border-l-0 lg:border-b-2 lg:px-5">
          ...
          <span className="hidden sm:inline-flex">CoderHouse</span>
          <span className="hidden lg:inline-flex z-40 relative top-7 xl:-left-12 rounded-full bg-white">
            .
          </span>
        </li>
        <li className="duration-400 hover:text-purple-600 font-semibold border-l-2 pl-2 py-4 lg:border-l-0 lg:border-b-2 lg:px-5">
          ...
          <span className="hidden lg:inline-flex z-40 relative lg:top-7 -left-14 rounded-full bg-white">
            .
          </span>
        </li>
        <li className="duration-400 hover:text-purple-600 font-semibold border-l-2 pl-2 py-4 lg:border-l-0 lg:border-b-2 lg:px-5">
