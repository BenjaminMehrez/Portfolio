      ...
      <div className="mt-20 md:mt-0 flex flex-col md:flex-row justify-between items-center mx-auto gap-10">
        <div data-aos="fade-right" className="md:w-[39%]">
          ...
          <div className="flex mt-6 space-x-3 items-center">
            <a
              rel="noreferrer"
              href="https://github.com/BenjaminMehrez"
              target="_blank"
            ...
            <a
              rel="noreferrer"
              href="/benjaminMehrezCV.pdf"
              download="benjaminMehrezCV.pdf"
              className="flex shadow-purple-900 overflow-hidden items-center text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-black shadow hover:bg-black/90 h-12 px-4 py-2 max-w-52 whitespace-pre md:flex group relative justify-center rounded-md transition-all duration-300 ease-out"
            >
              <span className="absolute right-0 -mt-12 h-32 w-8 translate-x-12 rotate-12 bg-white opacity-10 transition-all duration-1000 ease-out group-hover:-translate-x-40"></span>
              <div className="flex items-center">
                <img className="w-5 h-5 fill-current" src="/cv.svg" alt="cv" />
              </div>
            </a>
            <a
              rel="noreferrer"
              href="https://www.linkedin.com/in/benjamin-mehrez-ab907b30b/"
              target="_blank"
            ...
            >
              ...
              <span className="origin-left inline-flex duration-100 group-hover:duration-300 group-hover:delay-500 opacity-0 group-hover:opacity-100 border-l-2 px-2 transform scale-x-0 group-hover:scale-x-100 transition-all">
                Benjamin Mehrez
              </span>
            </a>
          </div>
          <a
            rel="noreferrer"
            href="mailto:mehrezbenjamin@gmail.com"
            target="_blank"
            className="flex mt-3 shadow-purple-900 overflow-hidden items-center text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-black shadow hover:bg-black/90 h-12 whitespace-pre md:flex group relative justify-center rounded-md transition-all duration-300 ease-out"
          >
            <span className="absolute right-0 -mt-12 h-32 w-8 translate-x-12 rotate-12 bg-white opacity-10 transition-all duration-1000 ease-out group-hover:-translate-x-40"></span>
            <div className="flex items-center">
              <span className="font-semibold">mehrezbenjamin@gmail.com</span>
            </div>
          </a>
        </div>
        <div
